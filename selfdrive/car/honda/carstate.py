...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, cp_body):
    ...
    if self.CP.enableGasInterceptor:
      ...
      self.user_gas_pressed = self.user_gas > 10 #change to 2 because in 2020 odyssey this will some time reach 2  # this works because interceptor read < 0 when pedal position is 0. Once calibrated, this will change
